...
export default function Home() {
  ...
  return (
    <div className="flex items-center justify-center w-screen min-h-screen bg-gray-100">
      <Card className="w-1/2 max-w-lg bg-white shadow-md">
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              <h2 className="font-semibold text-3xl text-gray-800">Wallet</h2>
            </div>
        ...
        <CardContent>
          ...
          {/* deposit money */}
          <Separator className="my-4" />
          <p className="text-lg font-bold mb-3 text-gray-800">Deposit Money</p>
          <div className="flex gap-3">
            <Input
              className="max-w-xs"
          ...
          {/* withdraw section */}
          <Separator className="my-4" />
          <p className="text-lg font-bold mb-3 text-gray-800">Withdraw Money</p>
          <div className="flex gap-3">
            <Input
              className="max-w-xs"
          ...
          {/* transfer section */}
          <Separator className="my-4" />
          <p className="text-lg font-bold mb-3 text-gray-800">Transfer Money</p>
          <Input
